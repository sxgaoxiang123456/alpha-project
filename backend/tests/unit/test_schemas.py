...
def test_watchlist_create_rejects_invalid_cost_price_string():
    from backend.app.schemas.watchlist import WatchlistItemCreate
...
def test_stock_and_watchlist_reject_non_six_digit_codes():
    from backend.app.schemas.stock import StockBase
    from backend.app.schemas.watchlist import WatchlistCsvRow, WatchlistItemCreate
...
def test_watchlist_rejects_negative_cost_price_and_shares():
    from backend.app.schemas.watchlist import WatchlistItemCreate, WatchlistItemUpdate
...
def test_group_create_rejects_blank_name():
    from backend.app.schemas.group import GroupCreate
...
def test_watchlist_csv_row_validates_csv_contract():
    from backend.app.schemas.watchlist import WatchlistCsvRow
...
def test_response_schemas_support_model_validate_from_attributes():
    ...
    from backend.app.schemas import GroupResponse, StockResponse, WatchlistItemResponse
...
def test_watchlist_response_rejects_negative_cost_price_from_attributes():
    from backend.app.models.watchlist import WatchlistItem
    from backend.app.schemas import WatchlistItemResponse
