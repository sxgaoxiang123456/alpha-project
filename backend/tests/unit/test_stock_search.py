...
def test_search_stock_by_code_returns_akshare_match():
    from backend.app.services.stock_search import search_stock
...
def test_search_stock_rejects_invalid_code_format_without_querying_providers():
    from backend.app.services.stock_search import StockCodeFormatError, search_stock
...
def test_search_stocks_by_name_returns_candidates_from_akshare():
    from backend.app.services.stock_search import search_stocks
...
def test_search_stock_raises_source_unavailable_without_manual_name():
    from backend.app.services.stock_search import StockDataSourceUnavailableError, search_stock
...
def test_search_stocks_rejects_code_like_invalid_query_without_querying_providers():
    from backend.app.services.stock_search import StockCodeFormatError, search_stocks
...
def test_search_stocks_by_name_raises_when_akshare_unavailable():
    from backend.app.services.stock_search import StockDataSourceUnavailableError, search_stocks
...
def test_search_functions_reject_none_query_without_querying_providers():
    from backend.app.services.stock_search import StockCodeFormatError, search_stock, search_stocks
