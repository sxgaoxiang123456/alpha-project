...
T004 [US1] [BE] _push_service_factory() wiring tests (RED)
...
- [ ] T004 [US1] [BE] _push_service_factory wiring tests
- [ ] T005 [P] [US1] [BE] alert-to-push integration test
- [ ] T006 [US1] [BE] Instantiate FeishuClient from env config
- [ ] T007 [US1] [INT] Run US1 checks
